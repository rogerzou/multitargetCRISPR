...
hic.get_span_width(gen, h2GGin, h2WTin, ana_3 + "GG-Mfilt_gh2ax_width")
gen = hic.gen_filter_dist(m.macs_gen(CT_mre11, 1250, hg38, AluCT), 2000000)
hic.get_span_width(gen, h2CTin, h2WTin, ana_3 + "CT-Mfilt_gh2ax_width")
gen = hic.gen_filter_dist(m.macs_gen(TA_mre11, 1250, hg38, AluTA), 2000000)
hic.get_span_width(gen, h2TAin, h2WTin, ana_3 + "TA-Mfilt_gh2ax_width")
gen = hic.gen_filter_dist(m.macs_gen(GG_mre11, 1250, hg38, AluGG), 2000000)
hic.get_span_width(gen, bpGGin, bpWTin, ana_3 + "GG-Mfilt_53bp1_width")
gen = hic.gen_filter_dist(m.macs_gen(CT_mre11, 1250, hg38, AluCT), 2000000)
hic.get_span_width(gen, bpCTin, bpWTin, ana_3 + "CT-Mfilt_53bp1_width")
gen = hic.gen_filter_dist(m.macs_gen(TA_mre11, 1250, hg38, AluTA), 2000000)
hic.get_span_width(gen, bpTAin, bpWTin, ana_3 + "TA-Mfilt_53bp1_width")
